...
def _maybe_auto_subscribe(conn: Any, task_id: str) -> bool:
    ...
    try:
        ...
        # Preserve fallback identities established above. Empty ContextVars
        # must not erase the canonical continuation address.
        session_key = get_session_env("HERMES_SESSION_KEY", "") or session_key
        session_id = get_session_env("HERMES_SESSION_ID", "") or pending_session_id
        is_gateway_session = platform not in {"tui", "session"}
