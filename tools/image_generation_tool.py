...
IMAGE_GENERATE_SCHEMA = {
    ...
    "description": (
        ...
        "When a `profile_selfie` tool is available and the requested image "
        "depicts the active profile/persona (selfie, appearance, outfit, pose, "
        "face, or body), use `profile_selfie` instead; use this tool for other "
