...
DEFAULT_CONFIG = {
    ...
    "agent": {
        ...
        # Cron runs have no interactive resume path, so give them a small
        # graceful drain floor during restart.
        "cron_drain_timeout": 30,
        # Wait for active work before entering stop()/drain on in-band restart.
    ...
    "skills": {
        ...
        # Strict allowlist. Missing/empty means no interactive skills.
        "enabled": [],
